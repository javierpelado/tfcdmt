    ...
    return ret;
        ...
        function desmultiplicar(word) {
           ...
           if (exceptions.indexOf(lword) == -1 && lword.substr(0,3) != '...') {
                ...
                /*palabras en ingl�s. Sirve para pasar google, good, teen, etc     */
...
//                    alert("risa1");
                    ...
                    else if (lword.length > 8 && lword.match(/^((j|a|k|h|l|s|d|�)+)j((j|a|k|h|l|s|d|�)+)j((j|a|k|h|l|s|d|�)*)$/)) {
//                    alert(lword);
                         return "jajaja";
                    }
        ...
        function desk(word) {
            exceptions = new Array('kiosco', 'kilo', 'kil�', 'fuck', 'punk', 'rock', 'look', 'kiss');
        ...
        function deszezear(word) {
            exceptions = new Array('arroz', 'feliz', 'zorr', 'azul', 'azucar', 'az�car', 'conoz');
            lword = word.toLowerCase();
    ...
    function desfotologuear(sentence) {
        console.log(sentence);
        original = dessimbolizar(sentence);
